...
public class S_EMThread extends StoppableThread{
	...
	public S_EMThread(AbstractDataSource SourceA, AbstractDataSource SourceB, AbstractJoinCondition condition, int parBlockPairIndex) {
			try {
	...
	public void run() {
		try {
			...
			DataSampleInterface leftSource = new RandomSampler(mySourceA, 100);
			DataSampleInterface rightSource = new RandomSampler(mySourceB, 100);
